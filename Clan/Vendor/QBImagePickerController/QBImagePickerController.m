...
- (void)dealloc
{
    DLog(@"QBImagePickerController dealloc ");
}
                            ...
                            resultBlock:^(ALAsset *asset) {
                                ...
                                if (!asset) {
                                    ...
                                    [weakSelf.assetsLibrary enumerateGroupsWithTypes:ALAssetsGroupPhotoStream usingBlock:^(ALAssetsGroup *group, BOOL *stop) {
                                        ...
                                        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"" message:@"所选照片不可用" delegate:nil cancelButtonTitle:@"好" otherButtonTitles:nil, nil];
                                        [alert show];
                                    }];
                                } else {
