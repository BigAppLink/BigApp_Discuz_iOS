...
@interface LucImageCropperViewController ()
...
@implementation LucImageCropperViewController
...
- (void)initControlBtn
{
    ...
    bottombar.alpha = 0.8;
    bottombar.frame = CGRectMake(0, self.view.frame.size.height - 50.0f, self.view.frame.size.width, 50);
...
{
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(LucImageCropperDelegate)]) {
